...
\item L'une des observations de base sur le réchauffement climatique c'est que le facteur $\epsilon$ que quantifie l'effet de Serre est une fonction du logarithme de la concentration de $CO_2$ dans l'atmosphère:
