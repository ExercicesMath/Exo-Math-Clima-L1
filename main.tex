...
\item Une observation de base pour les modèles de prévision pour le réchauffement climatique c'est que le facteur $\epsilon$, que quantifie l'effet de Serre, est une fonction du logarithme de la concentration de $CO_2$ dans l'atmosphère (voir \href{https://en.wikipedia.org/wiki/Svante_Arrhenius#Greenhouse_effect}{ici})
